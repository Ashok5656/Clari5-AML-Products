...
import { Lock, User, Eye, EyeOff, Shield, ShieldCheck, Zap, Brain, ArrowRight, TrendingUp, Activity, AlertTriangle, Fingerprint, Award, CheckCircle, Info, Globe } from "lucide-react";
...
export function LoginScreen({ onLogin }: LoginScreenProps) {
  ...
  return (
    <div className="h-screen relative overflow-hidden bg-[#2A53A0]">
      ...
      <div className="relative z-10 h-full grid lg:grid-cols-[55%_45%] xl:grid-cols-[60%_40%]">
        ...
        <motion.div
          ...
          className="flex flex-col justify-center p-6 lg:p-10 xl:p-16 relative"
        >
          <div className="max-w-2xl space-y-6 relative z-10">
            ...
            <div>
              ...
              <h1 className="text-4xl lg:text-6xl font-bold mb-4 leading-[1.1] text-white tracking-tight drop-shadow-2xl">
                Advanced Fraud
                <br />
              ...
              <p className="text-base lg:text-lg text-blue-100/70 mb-6 leading-relaxed font-light max-w-lg">
                Next-generation enterprise security with AI-powered compliance monitoring and real-time threat intelligence.
              </p>
            </div>

            {/* HUD Style Capability Cards */}
        ...
        <motion.div
          ...
          className="flex items-center justify-center p-6 lg:p-8 xl:p-12 relative"
        >
          <div className="w-full max-w-md relative z-10">
            ...
            <div className="bg-white dark:bg-gray-900 rounded-[2rem] shadow-[0_20px_60px_-15px_rgba(0,0,0,0.3)] border border-white/20 p-8 lg:p-10 relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                {/* Footer Info */}
                <div className="mt-4 pt-6 border-t border-gray-100 dark:border-gray-800/50">
