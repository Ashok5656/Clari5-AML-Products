        ...
        <div className="lg:col-span-2">
          <Card className="border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 shadow-sm h-full">
            <div className="p-6">
              ...
              <ResponsiveContainer width="100%" height={300} id="qa-assurance-trend-container" key="qa-assurance-trend-container">
                <AreaChart data={qaTrendData} id="qa-assurance-trend-chart" key="qa-assurance-trend-chart">
                  <defs>
                  ...
                  <CartesianGrid strokeDasharray="3 3" vertical={false} stroke="#e5e7eb" key="qa-trend-grid" />
                  <XAxis dataKey="month" axisLine={false} tickLine={false} tick={{ fill: '#6b7280' }} dy={10} key="qa-trend-xaxis" />
                  <YAxis axisLine={false} tickLine={false} tick={{ fill: '#6b7280' }} key="qa-trend-yaxis" />
                  <Tooltip key="qa-trend-tooltip" />
                  <Area type="monotone" dataKey="passRate" stroke="#2A53A0" strokeWidth={2} fillOpacity={1} fill="url(#colorPass)" name="Pass Rate %" key="qa-trend-area" />
                  <Line type="monotone" dataKey="defects" stroke="#ef4444" strokeWidth={2} strokeDasharray="5 5" name="Defects" key="qa-trend-line" />
                </AreaChart>
              </ResponsiveContainer>
            </div>
          </Card>
            ...
            <div className="p-6">
              ...
              <div className="flex flex-col gap-3">
                <div className="space-y-4">
                  {issueData.map((issue) => (
                    <div key={`issue-severity-${issue.name}`} className="space-y-1">
          ...
          <table className="w-full">
            ...
            <tbody className="divide-y divide-gray-200 dark:divide-gray-800">
              {sortedReviews.map((review) => (
                <tr key={`review-row-${review.id}`} className="hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors">
