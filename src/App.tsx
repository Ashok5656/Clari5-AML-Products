      ...
      <div className="h-screen flex flex-col bg-gradient-to-br from-gray-50 via-white to-gray-100 dark:from-gray-950 dark:via-gray-900 dark:to-gray-950 transition-colors duration-300 overflow-hidden">
        <div className="flex-1 flex overflow-hidden">
          ...
          <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
            ...
            <main ref={mainContentRef} className={activeItem === "config-sanctions-screening-configuration" ? "flex-1 overflow-hidden flex flex-col p-4 gap-4" : activeItem.startsWith("reg_gen-") || activeItem === "ai-graphical-network-analysis" || activeItem === "config-scenario-authoring-tool" || activeItem === "kyc-customer-360-view" || activeItem === "ai-customer-360-view" || activeItem === "simulation-alerts-simulation" || activeItem.startsWith("sanctions-manual-screening") || activeItem === "sanctions-sanction-screening-workflow" || activeItem === "sanctions-sanction-mis-reports" || activeItem === "config-human-trafficking-alerts-configuration" || activeItem === "config-tbml-proliferation-financing-alerts-configuration" || activeItem === "config-wildlife-trafficking-alerts-configuration" || activeItem === "config-mule-alerts-configuration" || activeItem === "config-cyber-enabled-fraud-configuration" || activeItem === "config-high-risk-countries" || activeItem === "config-out-of-the-box-tm-rules-configuration" || activeItem === "config-sanctions-screening-configuration" ? "flex-1 overflow-hidden flex flex-col" : "flex-1 hover-scroll"}>
              {!activeItem.startsWith("reg_gen-") && activeItem !== "ai-graphical-network-analysis" && activeItem !== "simulation-alerts-simulation" && !activeItem.startsWith("sanctions-manual-screening") && activeItem !== "sanctions-sanction-screening-workflow" && activeItem !== "sanctions-sanction-mis-reports" && activeItem !== "config-human-trafficking-alerts-configuration" && activeItem !== "config-tbml-proliferation-financing-alerts-configuration" && activeItem !== "config-wildlife-trafficking-alerts-configuration" && activeItem !== "config-mule-alerts-configuration" && activeItem !== "config-cyber-enabled-fraud-configuration" && activeItem !== "config-high-risk-countries" && activeItem !== "config-out-of-the-box-tm-rules-configuration" && activeItem !== "config-sanctions-screening-configuration" && !activeItem.toLowerCase().includes("event") && <ScrollToTopButton scrollRef={mainContentRef} />}
              <div className={activeItem.startsWith("reg_gen-") || activeItem === "ai-graphical-network-analysis" || activeItem === "config-scenario-authoring-tool" || activeItem === "simulation-alerts-simulation" || activeItem === "kyc-customer-360-view" || activeItem === "ai-customer-360-view" || activeItem.startsWith("sanctions-manual-screening") || activeItem === "sanctions-sanction-screening-workflow" || activeItem === "sanctions-sanction-mis-reports" || activeItem === "config-human-trafficking-alerts-configuration" || activeItem === "config-tbml-proliferation-financing-alerts-configuration" || activeItem === "config-wildlife-trafficking-alerts-configuration" || activeItem === "config-mule-alerts-configuration" || activeItem === "config-cyber-enabled-fraud-configuration" || activeItem === "config-high-risk-countries" || activeItem === "config-out-of-the-box-tm-rules-configuration" || activeItem === "config-sanctions-screening-configuration" ? "flex-1 h-full" : "p-4"}>
