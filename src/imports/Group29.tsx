import svgPaths from "./svg-7f6fvi704m";
...
function Checkmark() {
  return (
    <div className="absolute left-[190.44px] size-[18px] top-[22.5px]" data-name="Checkmark">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 18 18">
        <g id="Checkmark">
...
function Group() {
  return (
    <div className="absolute contents left-[52.44px] top-[21px]">
      <Checkmark />
      <p className="-translate-x-1/2 absolute font-['Inter:Medium',sans-serif] font-medium leading-[21px] left-[118.44px] not-italic text-[14px] text-center text-white top-[21px] whitespace-nowrap">{` Save Configuration`}</p>
    </div>
  );
}
...
function DialogContent() {
  return (
    <div className="absolute bg-white h-[621.25px] left-[703px] rounded-[8px] top-[161.38px] w-[512px]" data-name="DialogContent">
