import svgPaths from "./svg-2psn8fqtw6";
...
function Container2() {
  return (
    <div className="h-[20px] relative shrink-0 w-[119.766px]" data-name="Container">
...
function Container4() {
  return (
    <div className="h-[24px] relative shrink-0 w-[101.172px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[8px] items-center relative size-full">
        <Text1 />
        <Button3 />
      </div>
...
function GR() {
  return (
    <div className="flex-[1_0_0] h-[24px] min-h-px min-w-px relative" data-name="gR">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[8px] items-center relative size-full">
        <Container2 />
        <Container3 />
        <Container4 />
...
function Tt() {
  return (
    <div className="bg-white h-[48px] relative shrink-0 w-full" data-name="Tt">
...
function Text3() {
  return (
    <div className="h-[18px] relative shrink-0 w-[71.859px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
...
function Text4() {
  return (
    <div className="h-[19.5px] relative shrink-0 w-[109.344px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
...
function Text5() {
  return (
    <div className="h-[18px] relative shrink-0 w-[43.625px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
...
function Text6() {
  return (
    <div className="h-[18px] relative shrink-0 w-[39.234px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
...
function Text7() {
  return (
    <div className="h-[18px] relative shrink-0 w-[31.547px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
...
function Text8() {
  return (
    <div className="h-[18px] relative shrink-0 w-[68.313px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
...
function Text9() {
  return (
    <div className="h-[19.5px] relative shrink-0 w-[374.016px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid overflow-clip relative rounded-[inherit] size-full">
...
function Text10() {
  return (
    <div className="h-[21px] relative shrink-0 w-[40.266px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="-translate-x-1/2 absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[21px] left-[20.5px] not-italic text-[#2a53a0] text-[14px] text-center top-0 whitespace-nowrap">Fields</p>
      </div>
    </div>
  );
}
...
function U4E2() {
  return (
    <div className="h-[21px] relative shrink-0 w-[75.922px]" data-name="u4e">
...
function PrimitiveButton() {
  return (
    <div className="absolute bg-white content-stretch flex h-[47px] items-center justify-center left-0 pb-[2px] pl-px pr-[1.016px] pt-px top-0 w-[813px]" data-name="Primitive.button">
...
function PrimitiveButton1() {
  return (
    <div className="absolute content-stretch flex h-[47px] items-center justify-center left-[813px] pb-[6px] pt-[5px] px-[17px] top-0 w-[813px]" data-name="Primitive.button">
      <div aria-hidden="true" className="absolute border-[rgba(0,0,0,0)] border-b-2 border-l border-r border-solid border-t inset-0 pointer-events-none" />
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[21px] not-italic relative shrink-0 text-[#525252] text-[14px] text-center whitespace-nowrap">Mapping</p>
    </div>
  );
}
...
function PrimitiveDiv1() {
  return (
    <div className="h-[47px] relative shrink-0 w-[1626px]" data-name="Primitive.div">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <PrimitiveButton />
        <PrimitiveButton1 />
      </div>
...
function U4E1() {
  return (
    <div className="bg-white h-[161px] relative shrink-0 w-[1658px]" data-name="u4e">
      <div aria-hidden="true" className="absolute border-[#f3f4f6] border-b border-solid inset-0 pointer-events-none" />
...
function Button5() {
  return (
    <div className="absolute bg-white border border-[#2a53a0] border-solid h-[46px] left-0 rounded-[8px] top-px w-[125.094px]" data-name="Button">
      <Icon1 />
      <p className="-translate-x-1/2 absolute font-['Inter:Medium',sans-serif] font-medium leading-[21px] left-[74.5px] not-italic text-[#2a53a0] text-[14px] text-center top-[11.5px] whitespace-nowrap">{` Download`}</p>
    </div>
  );
}
...
function Icon2() {
  return (
    <div className="absolute left-[16px] size-[16px] top-[14px]" data-name="Icon">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="Icon">
          <path d={svgPaths.p1c30a680} fill="var(--fill-0, #2A53A0)" id="Vector" />
          <path d="M2 9.5H7V10.5H2V9.5Z" fill="var(--fill-0, #2A53A0)" id="Vector_2" />
          <path d="M2 12H7V13H2V12Z" fill="var(--fill-0, #2A53A0)" id="Vector_3" />
          <path d="M9 4H14V5H9V4Z" fill="var(--fill-0, #2A53A0)" id="Vector_4" />
          <path d={svgPaths.p38ca8400} fill="var(--fill-0, #2A53A0)" id="Vector_5" />
        </g>
      </svg>
    </div>
  );
...
function Button6() {
  return (
    <div className="absolute bg-white border border-[#2a53a0] border-solid h-[46px] left-[137.09px] rounded-[8px] top-px w-[176.828px]" data-name="Button">
      <Icon2 />
      <p className="-translate-x-1/2 absolute font-['Inter:Medium',sans-serif] font-medium leading-[21px] left-[99.5px] not-italic text-[#2a53a0] text-[14px] text-center top-[11.5px] whitespace-nowrap">{` Add Derived Field`}</p>
    </div>
  );
}
...
function Button7() {
  return (
    <div className="absolute bg-[#2a53a0] h-[46px] left-[325.92px] rounded-[8px] top-px w-[119.047px]" data-name="Button">
      <Icon3 />
      <p className="-translate-x-1/2 absolute font-['Inter:Medium',sans-serif] font-medium leading-[21px] left-[72.5px] not-italic text-[14px] text-center text-white top-[12.5px] whitespace-nowrap">{` Add Field`}</p>
    </div>
  );
}

function Container14() {
  return <div className="absolute bg-[#e5e7eb] h-[24px] left-[460.97px] top-[12px] w-px" data-name="Container" />;
}
...
function Icon4() {
  return (
    <div className="absolute left-[16px] size-[16px] top-[15px]" data-name="Icon">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="Icon">
          <path d={svgPaths.p31f9c780} fill="var(--fill-0, #99A1AF)" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function Button8() {
  return (
    <div className="absolute bg-[#f3f4f6] h-[46px] left-[477.97px] opacity-50 rounded-[8px] top-px w-[151.109px]" data-name="Button">
      <Icon4 />
      <p className="-translate-x-1/2 absolute font-['Inter:Regular',sans-serif] font-normal leading-[21px] left-[88.5px] not-italic text-[#99a1af] text-[14px] text-center top-[12.5px] whitespace-nowrap">{` Save Changes `}</p>
    </div>
  );
}
...
function Container13() {
  return (
    <div className="absolute h-[48px] left-[996.92px] top-0 w-[629.078px]" data-name="Container">
      <Button5 />
      <Button6 />
      <Button7 />
      <Container14 />
...
function TextInput() {
  return (
    <div className="absolute bg-white h-[48px] left-0 rounded-[8px] top-0 w-[280px]" data-name="Text Input">
      <div className="content-stretch flex items-center overflow-clip pl-[44px] pr-[16px] relative rounded-[inherit] size-full">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[#99a1af] text-[14px] whitespace-nowrap">Search fields...</p>
      </div>
  ...
  return (
    <div className="h-[18px] overflow-clip relative shrink-0 w-full" data-name="Icon">
      <div className="absolute inset-[6.14%_9.37%_9.37%_6.14%]" data-name="Vector">
        <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 15.2074 15.2074">
          <path d={svgPaths.p1d6c7f00} fill="var(--fill-0, #99A1AF)" id="Vector" />
        </svg>
      </div>
    </div>
  );
...
function Container16() {
  return (
    <div className="absolute content-stretch flex flex-col items-start left-[16px] size-[18px] top-[15px]" data-name="Container">
      <Icon5 />
    </div>
  );
}
...
function Container15() {
  return (
    <div className="absolute h-[48px] left-0 top-0 w-[280px]" data-name="Container">
      <TextInput />
      <Container16 />
    </div>
  );
...
function U4E4() {
  return (
    <div className="h-[48px] relative shrink-0 w-[1626px]" data-name="u4e">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <Container13 />
        <Container15 />
      </div>
...
function Sn() {
  return (
    <div className="absolute bg-white content-stretch flex h-[48px] items-center justify-between left-px pt-px top-[592px] w-[1624px]" data-name="Sn">
...
function Container25() {
  return (
    <div className="absolute bg-white h-[591px] left-px overflow-clip top-px w-[1624px]" data-name="Container">
      <Table />
      <TableHeader />
    </div>
  );
...
function U4E5() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px min-w-px relative rounded-[4px] w-[1626px]" data-name="u4e">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid overflow-clip relative rounded-[inherit] size-full">
        <Sn />
        <Container25 />
      </div>
...
function PrimitiveDiv2() {
  return (
    <div className="bg-white content-stretch flex flex-col gap-[16px] h-[705px] items-start relative rounded-[4px] shrink-0 w-full" data-name="Primitive.div">
      <U4E4 />
      <U4E5 />
    </div>
  );
...
function U4E3() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px min-w-px relative w-[1658px]" data-name="u4e">
...
function PrimitiveDiv() {
  return (
    <div className="flex-[1_0_0] min-h-px min-w-px relative w-[1658px]" data-name="Primitive.div">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
        <U4E1 />
        <U4E3 />
      </div>
