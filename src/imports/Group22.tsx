import svgPaths from "./svg-7xoxsu1q46";
...
function Container() {
  return (
    <div className="absolute bg-gradient-to-b content-stretch flex from-[#3e71cd] h-[90px] items-center justify-between left-0 px-[24px] rounded-[12px] shadow-[0px_1px_3px_0px_rgba(0,0,0,0.1),0px_1px_2px_0px_rgba(0,0,0,0.1)] to-[#2a53a0] top-0 w-[1616px]" data-name="Container">
      <Container1 />
      <Container8 />
    </div>
  );
...
function Container9() {
  return (
    <div className="absolute h-[154px] left-0 top-[106px] w-[1616px]" data-name="Container">
      <Container10 />
      <Container12 />
      <Container14 />
      <Container16 />
...
function Container20() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[16px] h-[156px] items-start left-0 top-[276px] w-[1616px]" data-name="Container">
      <Heading1 />
      <Container21 />
    </div>
  );
...
function Container30() {
  return (
    <div className="absolute bg-white h-[699.5px] left-0 rounded-[8px] top-[448px] w-[1616px]" data-name="Container">
...
function Frame1() {
  return (
    <div className="absolute h-[120px] left-[508px] top-[646px] w-[122.047px]">
      <Group4 />
    </div>
  );
}
...
function Group1() {
  return (
    <div className="absolute contents left-0 top-[448px]">
      <Container30 />
      <Frame1 />
    </div>
  );
...
function Group6() {
  return (
    <div className="absolute contents left-0 top-[448px]">
      <Container142 />
      <button className="absolute content-stretch cursor-pointer flex flex-col items-start left-[1066px] p-[10px] top-[526px] w-[180px]" data-name="Clari5 Dropdown">
        <div className="content-stretch flex flex-col isolate items-start relative shrink-0 w-full" data-name="Dropdown - Default">
          <div aria-hidden="true" className="absolute bg-[rgba(255,255,255,0)] inset-0 mix-blend-multiply pointer-events-none" />
          <DropdownInput />
        </div>
      </button>
      <button className="absolute content-stretch cursor-pointer flex flex-col items-start left-[1242px] p-[10px] top-[526px] w-[180px]" data-name="Clari5 Dropdown">
        <div className="content-stretch flex flex-col isolate items-start relative shrink-0 w-full" data-name="Dropdown - Default">
          <div aria-hidden="true" className="absolute bg-[rgba(255,255,255,0)] inset-0 mix-blend-multiply pointer-events-none" />
          <DropdownInput1 />
        </div>
      </button>
      <button className="absolute content-stretch cursor-pointer flex flex-col items-start left-[1418px] p-[10px] top-[526px] w-[190px]" data-name="Clari5 Dropdown">
        <div className="content-stretch flex flex-col isolate items-start relative shrink-0 w-full" data-name="Dropdown - Default">
          <div aria-hidden="true" className="absolute bg-[rgba(255,255,255,0)] inset-0 mix-blend-multiply pointer-events-none" />
          <DropdownInput2 />
        </div>
...
export default function Group21() {
  return (
    <div className="relative size-full">
      <Group />
      <Group19 />
      <div className="absolute bg-[rgba(217,217,217,0)] h-[10px] left-0 top-[1148px] w-[1616px]" />
    </div>
  );
}